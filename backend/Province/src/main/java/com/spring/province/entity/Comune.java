...
@Entity
@Table(name="gi_comuni_modificato")
public class Comune {
	
	
	@ManyToOne
    @JoinColumn(name = "sigla_provincia", referencedColumnName = "sigla_provincia")
	...
	public Comune(Provincia provincia, Integer codice_istat, String denominazione_ita_altra, String denominazione_ita,
